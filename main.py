...
def run_panoramic_pipeline(
    ...
    merged_splat, per_pano_splats = processor.process(all_sharp_views, gaussian_list, pano_poses=pano_poses, da3_world_pts=da3_pts_per_pano, scale_mode="da3_y_ground")
