...
def _extract_slice(equ, yaw, pitch, hfov, w, h, output_path, pano_id, depth_equ=None) -> View:
...
def extract_views(
    ...
    for i in range(slice_count):
        ...
        views.append(_extract_slice(equ, yaw, 0, horizon_hfov, slice_w, slice_h,
...
def extract_views_for_da3(
    ...
    while yaw < 360.0:
        ...
        views.append(_extract_slice(equ, yaw, 0, HFOV, slice_w, slice_h,
