...
Convert a Google Street View-style panorama (equirectangular JPEG) into a 3D Gaussian Splat. Used by [street-view-to-3dgs](https://github.com/YellowO2/streetview-to-3dgs), a Gradio app that fetches Google Street View panoramas and generates 3DGS scenes from them. Supporting nearby panoramas can be passed in to improve the depthmap generated by DA3, which may help produce a better final result.
